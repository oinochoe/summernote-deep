 ...
 <script src="/Content/js/summernote/codemirror/codemirror.min.js"></script>
    // summerNote Start
    <script src="/Content/js/summernote/summernote.min.js"></script>
    // langs
    <script src="/Content/js/summernote/langs/summernote-@(CookieLib.GetCookie("lang")).js"></script>
    <script>
        // summernote init
                        ...
                        var button = ui.button({
                            ...
                            click: function () {
                                ...
                                if (!question.match(/^(http(s)?:\/\/)?((w){3}.)?youtu(be|.be)?(\.com)?\/.+/)) {
                                    ...
                                    question = 'https://www.youtube.com/embed/' + question + '?enablejsapi=1&autoplay=0&controls=1&showinfo=0&rel=0&modestbranding=1&widgetid=1';
                                    iframe.src = question;
